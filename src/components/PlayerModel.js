...
import { state,setCurrentPlayerPosition, setAnimateNextLevel, setExecuting, setAnimateFall, startMoves,resetMoves, nextMove } from "../State";
...
export const  PlayerModel = (props) =>{
  ...
  const getDirection = (dir) => {
    ...
    else if(dir%4===1 || dir%4 ===-3) return["x","sub"];
    else if(dir%4===-1 || dir%4===3) return["x","add"];
